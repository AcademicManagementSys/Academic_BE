...
class AttendanceControllerTest {
    ...
    void 필수_파라미터가_없으면_422를_반환한다() throws Exception {
        mockMvc.perform(get("/v1/attendance").param("classId", "3"))
    ...
    void 반_단위_출석을_일괄_저장하면_201을_반환한다() throws Exception {
        ...
        mockMvc.perform(post("/v1/attendance/bulk")
    ...
    void 존재하지_않는_출석_기록을_수정하면_404를_반환한다() throws Exception {
        ...
        mockMvc.perform(patch("/v1/attendance/999")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void 학생_월별_출석을_조회한다() throws Exception {
        ...
        mockMvc.perform(get("/v1/students/101/attendance").param("month", "2026-08"))
                .andExpect(status().isOk())
